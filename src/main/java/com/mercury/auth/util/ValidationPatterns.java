...
public final class ValidationPatterns {
     ...
     * Must start and end with a letter/number to avoid leading/trailing spaces (internal spaces allowed, including consecutive)
     * Length calculation: 1 start char + (0-48 middle chars) + optional end char = 1-50 chars
