...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<PageResult<TenantUserItem>>> listTenantUsers(
            ...
            @org.springframework.web.bind.annotation.RequestParam(value = "nickname", required = false) String nickname,
        ...
        PageResult<TenantUserItem> result = userService.listTenantUsers(tenantId, currentUser.getUserId(), page, size, username, nickname, email, phone);
    ...
    public ResponseEntity<ApiResponse<List<TenantUserItem>>> searchTenantUsers(
        ...
        List<TenantUserItem> users = userService.searchTenantUsers(tenantId, currentUser.getUserId(), username, nickname, phone, email);
